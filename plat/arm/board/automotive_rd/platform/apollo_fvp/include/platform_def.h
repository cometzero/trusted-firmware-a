...
#define PLAT_ARM_MHU_NS_SHARED_SRAM_BASE	UL(0x180000)
...
#define APOLLO_FVP_CSS_AP_RSE_SECURE_MHU_BASE	UL(0x40680000)
...
#ifdef APOLLO_FVP_VARIANT_FVP
#define ARM_DRAM2_SIZE		 		SZ_2G
#elif defined(APOLLO_FVP_VARIANT_RTL)
...
#define APOLLO_FVP_CPER_BUF_BASE			UL(0xFFA00000)
#define APOLLO_FVP_CPER_BUF_SIZE			UL(0x00100000)

#define APOLLO_FVP_MAP_CPER_BUF			MAP_REGION_FLAT(APOLLO_FVP_CPER_BUF_BASE, \
						APOLLO_FVP_CPER_BUF_SIZE, \
 ...
 */
#define APOLLO_FVP_DEVICE_BASE		UL(0x10000000)
#define APOLLO_FVP_DEVICE_SIZE		UL(0x28000000)
#define APOLLO_FVP_MAP_DEVICE		MAP_REGION_FLAT(APOLLO_FVP_DEVICE_BASE, \
							APOLLO_FVP_DEVICE_SIZE, \
							MT_DEVICE | MT_RW | \
							MT_SECURE)
...
#define APOLLO_FVP_MAP_EXTERNAL_FLASH	MAP_REGION_FLAT(EXT_FLASH_BASE, \
							PLAT_ARM_FLASH_IMAGE_MAX_SIZE, \
							MT_DEVICE | MT_RO | \
							MT_SECURE)

/* SMD ATU region */
#define APOLLO_FVP_SMD_ATU_REGION_BASE	UL(0x40000000)
#define APOLLO_FVP_SMD_ATU_REGION_SIZE	UL(0x10000000)
#define APOLLO_FVP_MAP_SMD_ATU_REGION	MAP_REGION_FLAT(APOLLO_FVP_SMD_ATU_REGION_BASE, \
							APOLLO_FVP_SMD_ATU_REGION_SIZE, \
							MT_DEVICE | MT_RW | \
							MT_SECURE)
...
#define APOLLO_FVP_MAP_NS_DRAM1		MAP_REGION_FLAT(ARM_DRAM1_BASE, \
							NS_DRAM_SIZE, \
							MT_MEMORY | MT_RW | \
							MT_NS)

#define APOLLO_FVP_MAP_NS_DRAM2		MAP_REGION_FLAT(ARM_DRAM2_BASE, \
							ARM_DRAM2_SIZE,	\
							MT_MEMORY | MT_RW | \
							MT_NS)

/* Secure DRAM */
#define APOLLO_FVP_MAP_S_DRAM		MAP_REGION_FLAT(PLAT_ARM_SPMC_BASE, \
							PLAT_ARM_SPMC_SIZE, \
							MT_MEMORY | MT_RW | \
							MT_SECURE)
...
#define APOLLO_FVP_MAP_MEM_PROTECT		MAP_REGION_FLAT(PLAT_ARM_MEM_PROT_ADDR,	\
							EXT_FLASH_BLOCK_SIZE,	\
							MT_DEVICE | MT_RW | \
							MT_SECURE)

/* Non-volatile counters */
#define APOLLO_FVP_TRUSTED_NVCTR_BASE	UL(0x32030000)
#define APOLLO_FVP_TRUSTED_NVCTR_SIZE	UL(0x10000)
#define TFW_NVCTR_BASE			APOLLO_FVP_TRUSTED_NVCTR_BASE
#define TFW_NVCTR_SIZE			4
#define NTFW_CTR_BASE			(APOLLO_FVP_TRUSTED_NVCTR_BASE + 0x0004)
#define NTFW_CTR_SIZE			4

#define APOLLO_FVP_MAP_TRUSTED_NVCTR	MAP_REGION_FLAT(APOLLO_FVP_TRUSTED_NVCTR_BASE,	\
							APOLLO_FVP_TRUSTED_NVCTR_SIZE,	\
							MT_DEVICE | MT_RO | \
							MT_SECURE)
...
#define APOLLO_FVP_PRIMARY_CPU		0x0
...
#define AP_RSE_SECURE_MHU_V3_PBX	APOLLO_FVP_CSS_AP_RSE_SECURE_MHU_BASE
#define AP_RSE_SECURE_MHU_V3_MBX	APOLLO_FVP_CSS_AP_RSE_SECURE_MHU_BASE + \
 ...
 */
#define APOLLO_FVP_SCMI_PFDI_MONITOR_BASE			\
 ...
 * 32 + 8 = 40 bytes
 */
#define APOLLO_FVP_SCMI_PFDI_MONITOR_SIZE_PER_CHANNEL	40
#define APOLLO_FVP_SCMI_PFDI_MONITOR_SIZE_MAX		\
	(APOLLO_FVP_SCMI_PFDI_MONITOR_SIZE_PER_CHANNEL * PLAT_ARM_SCMI_PFDI_MONITOR_CHANNEL_COUNT)
